...
import { Send, Lightbulb, Thermometer, Coffee, User, Tv, Blinds, Lock, Unlock, Wind, Mic, MicOff, ShieldAlert } from "lucide-react";
...
export default function GuestApp() {
  ...
  return (
    <div style={{ width: '100%', maxWidth: '400px', height: '100vh', maxHeight: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', background: 'rgba(20,22,28,0.95)', border: '1px solid rgba(255,255,255,0.1)', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '16px', background: 'rgba(0,0,0,0.3)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <form onSubmit={handleSend} style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ position: 'relative', flex: 1 }}>
            ...
            />
            <button type="submit" style={{ position: 'absolute', right: '4px', top: '50%', transform: 'translateY(-50%)', padding: '8px', background: 'var(--accent-purple)', borderRadius: '50%', color: 'white', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Send size={16} />
            </button>
          </div>
        </form>
